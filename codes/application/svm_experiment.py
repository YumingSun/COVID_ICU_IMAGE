...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  5 22:37:48 2023
...
def evaluate_performance(allData, trainTestId, selectedClinic,
    ...
    clinicImageRsf = FastKernelSurvivalSVM(**clinicImageParam).fit(trainClinicImage,
                                                                             outcomeTrain)
    clinicRsf = FastKernelSurvivalSVM(**clinicParam).fit(trainClinic,outcomeTrain)
