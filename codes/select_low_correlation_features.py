...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  5 21:52:36 2023
...
if __name__ == '__main__':
    ...
    outcomeSub = allData.loc[:,['Event_First_ICU_to_Any_Death', 
    ...
    pickle.dump(clinicLowCor.columns.tolist(),
                open(os.path.join(clinicPath,
                                  'lowCorClinic_{:03d}.pkl'.format(numOfExp)),
                     'wb'))
    pickle.dump(clinicImageCor.columns.tolist(),
                open(os.path.join(imageClinicPath,
                                  'lowCorImageClinic_{:03d}.pkl'.format(numOfExp)),
                     'wb'))
