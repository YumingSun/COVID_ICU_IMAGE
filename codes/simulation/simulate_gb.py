...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 21:58:45 2023
...
def evaluate_performance(X, y, param):
    ...
    mod = GradientBoostingSurvivalAnalysis(**param).fit(x_train,y_train)
...
if __name__ == '__main__':
    ...
    gb_param = find_best_params(param_path,numOfExp)
    
    results = evaluate_performance(X,y,gb_param)
